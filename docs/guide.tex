...
\subsubsection{template.py}\label{template.py}
...
\begin{itemize}
	...
	\item{il path dela cartella con file statici che devono essere pubblicati in static_url_path. Il valore predefinito è la cartella 'static' nel percorso principale dell'applicazione.}
\end{itemize}
...
\begin{itemize}
	\item{render_template che è un metodo che attiva il motore di template e renderizza ai modelli specificati nel primo parametro mentre gli altri parametri sono coppie chiave/valore che rappresentano valori effettivi per le variabili a cui si fa riferimento nel modello;}
	...
	\item{l'oggetto url_for che, abbinato ad un altro metodo, genera un URL per l'endpoint specificato. 
