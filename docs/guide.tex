...
\begin{enumerate}
	\item{Il nome di una interfaccia alias è costitita dal nome dell'interfaccia più un due punti più
		un identificativo numero per l'alias stesso che parta da 0}
...
si elimina il nome dell'interfaccia ed i due punti (ad esempio  \texttt{ens0:1} diventa semplicemente 1) ottenendo
