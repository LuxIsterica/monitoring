...
Accetta N parametri di cui il primo\thank{Parametro obbligatorio} è la lista di parametri con cui è stata lanciata la funzione
...
\texttt{user} e \texttt{*groups} man anche le informazioni sull'utente ricavate attraverso la funzione \texttt{getuser()} e passate
