...
e un messaggio di errore che si trova nella chiave \texttt{stderr}. \\
...
che restituisce un \texttt{returncode} uguale a 0 e l'output sulla shell del comando eseguito nella chiave di dizionario \texttt{data}. \\
...
\texttt{command\_error} \'e l'opposto di \texttt{command\_success}. 
